...
from datasets.PairLoader import PairLoader
from model import MDDA

parser = argparse.ArgumentParser()
parser.add_argument('--model', default='MDDA.RCUNet', type=str, help='model name')
...
parser.add_argument('--train_set', default='../data/Denoise/train/Gaussian', type=str, help='train dataset name')
parser.add_argument('--val_set', default='../data/Denoise/val/Gaussian', type=str, help='valid dataset name')
parser.add_argument('--exp', default='RS-Haze', type=str, help='experiment setting')
