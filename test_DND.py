...
# from model.SIDD_light import RCUNet
...
parser.add_argument('--input_dir', default='../data/DND_test', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='../Results/DND/', type=str, help='Directory for results')
parser.add_argument('--weights', default='../checkpoints/SIDD/models/model_bestPSNR.pth', type=str, help='Path to weights')
