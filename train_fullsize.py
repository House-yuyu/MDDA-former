...
from datasets.data_RGB import get_trainingfullsize_data, get_validationfullsize_data
...
with open('options/Low_light.yaml', 'r') as config:
...
train_dataset = get_trainingfullsize_data(train_dir, None)
val_dataset = get_validationfullsize_data(val_dir, None)
