...
with open('options/Dehaze1.yaml', 'r') as config:
...
for epoch in range(start_epoch, OPT['EPOCHS'] + 1):
    ...
    ## Validation
        if (i+1) % eval_now == 0 and epoch > 200:
            with torch.no_grad():
                model.eval()
                psnr_val_rgb = []
                ssim_val_rgb = []
                ...
                if psnr_val_rgb > best_psnr:
                    ...
                    torch.save({'epoch': epoch,
                                ...
                                'optimizer': optimizer.state_dict()}, os.path.join(model_dir, "model_bestPSNR_4K.pth"))
                ...
                if ssim_val_rgb > best_ssim:
                    ...
                    torch.save({'epoch': epoch,
                                ...
                                }, os.path.join(model_dir, "model_bestSSIM_4K.pth"))
    ...
    torch.save({'epoch': epoch,
                'state_dict': model.state_dict(),
                'optimizer': optimizer.state_dict()}, os.path.join(model_dir, "model_latest_4K.pth"))
