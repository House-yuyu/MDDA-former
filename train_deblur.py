...
from datasets.loader import TrainDataset, ValDataset
...
with open('options/Deblur.yaml', 'r') as config:
...
## Resume
if Train['RESUME']:
    path_chk_rest = utils.get_last_path(model_dir, '_latest_ITS.pth')  # bestPSNR or latest
...
for epoch in range(start_epoch, OPT['EPOCHS'] + 1):
            ...
            with torch.no_grad():
                ...
                if psnr_val_rgb > best_psnr:
                    ...
                    torch.save({'epoch': epoch,
                                ...
                                'optimizer': optimizer.state_dict()}, os.path.join(model_dir, "model_bestPSNR_blur.pth"))
                ...
                if ssim_val_rgb > best_ssim:
                    ...
                    torch.save({'epoch': epoch,
                                ...
                                }, os.path.join(model_dir, "model_bestSSIM_blur.pth"))
    ...
    torch.save({'epoch': epoch,
                'state_dict': model.state_dict(),
                'optimizer': optimizer.state_dict()}, os.path.join(model_dir, "model_latest_blur.pth"))
